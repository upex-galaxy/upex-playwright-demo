...
test.describe('TS: ToolsQA | Elements | Radio Buttons', () => {
	...
	test('TC1: Validar poder selleccionar elemento radio button "Yes".', async ({ page }) => {
	...
	test('TC2: Validar poder selleccionar elemento radio button "Impressive".', async ({ page }) => {
	...
	test('TC3: Validar que elemento radio button "No" esté desabilitado.', async ({ page }) => {
